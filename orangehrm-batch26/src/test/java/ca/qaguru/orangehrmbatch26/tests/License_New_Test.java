...
public class License_New_Test extends TestBase {
    ...
    public void newLicenseAddition() throws InterruptedException {
        ...
        License_New_Page licensePage=new License_New_Page(driver);
